 ...
 * 创建作者：quanhongsheng
 */
@Component("paramMapHandler")
public class ParamMapHandler implements ChannelAwareMessageListener {
	...
	private static Logger logger = LoggerFactory.getLogger(ParamMapHandler.class);
	...
	public void onMessage(Message message, Channel channel) {
		...
		try {
			...
			logger.info("更新因子映射规则：" + msg);

			cgsService.initParamMap(1);
