 ...
 * 创建作者：quanhongsheng
 */
@Component("alramRuleHandler")
public class AlramRuleHandler implements ChannelAwareMessageListener {
	...
	private static Logger logger = LoggerFactory.getLogger(AlramRuleHandler.class);
	...
	public void onMessage(Message message, Channel channel) {
		...
		try {
			...
			logger.info("更新告警规则：" + msg);
			aasService.initAlarmRule();
