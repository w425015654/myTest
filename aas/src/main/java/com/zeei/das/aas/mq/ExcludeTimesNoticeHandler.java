 ...
 */
@Component
public class ExcludeTimesNoticeHandler implements ChannelAwareMessageListener {
	...
	private static Logger logger = LoggerFactory.getLogger(ExcludeTimesNoticeHandler.class);
	...
	public void onMessage(Message message, Channel channel) {
		...
		try {
			...
			logger.info("更新gk告警时段：" + msg);
			excludeTimeHandler.queryExcludeTime();
